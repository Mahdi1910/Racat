(function initializeSettingsManager(root, factory) {
    ...
    const TEXT = Object.freeze({
        ar: Object.freeze({
            ...
            camera_permission_denied: 'تم رفض إذن الكاميرا. اسمح للتطبيق باستخدام الكاميرا ثم حاول مرة أخرى.',
            camera_not_found: 'لم يتم العثور على كاميرا متاحة على هذا الجهاز.',
            camera_busy: 'تعذر استخدام الكاميرا لأنها مشغولة أو غير متاحة حالياً. أغلق أي تطبيق يستخدمها وحاول مرة أخرى.',
            camera_constraints: 'تعذر تشغيل الكاميرا بالإعدادات المطلوبة على هذا الجهاز.',
            camera_unsupported: 'هذا المتصفح أو العرض لا يدعم الوصول المطلوب إلى الكاميرا.',
            camera_start_failed: 'تعذر تشغيل الكاميرا بسبب خطأ غير متوقع. حاول مرة أخرى.',
        ...
        en: Object.freeze({
            ...
            error_model_library_load: 'The AI libraries could not load. Check your connection and reopen the app.',
            error_storage_read: 'The app could not access the saved AI model on this device.',
            error_model_download: 'The AI model could not be downloaded. Check your internet connection and try again.',
            error_storage_write: 'The AI model could not be saved. Free some storage and try again.',
            error_model_invalid: 'The downloaded AI model is invalid. Try downloading it again.',
            error_detector_init: 'The pose-detection engine could not start on this device. Try reopening the app.',
            ...
            camera_permission_denied: 'Camera permission was denied. Allow camera access and try again.',
            camera_not_found: 'No available camera was found on this device.',
            camera_busy: 'The camera is busy or unavailable. Close other apps using it and try again.',
            camera_constraints: 'The camera could not start with the requested settings on this device.',
            camera_unsupported: 'This browser or WebView does not support the required camera access.',
            camera_start_failed: 'The camera could not start because of an unexpected error. Try again.',
